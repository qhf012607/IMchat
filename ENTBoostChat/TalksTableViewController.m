...
@interface TalksTableViewController () <UITableViewDelegate, UITableViewDataSource, MJRefreshDelegate>
{
...
- (void)setupRefresh
{
    ...
    [self.tableView addHeaderWithDelegate:self viewHeight:-1.0 clipsToBounds:NO];
